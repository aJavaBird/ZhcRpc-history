...
public class BeanCheck04 {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext beanFactory = new ClassPathXmlApplicationContext(new String[] { "test04/beans.xml" }, true);
        ...
        IShowInfoService showInfoService = (IShowInfoService) beanFactory
                .getBean("com.cd.will.test.service.IShowInfoService", ZhcRpcService.class).getServiceBean();
